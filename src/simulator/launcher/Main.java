...
public class Main {
	...
	private static Options buildOptions() {
		...
		//mode
		cmdLineOptions.addOption(Option.builder("m").longOpt("mode").hasArg().desc("Execution Mode. Possible values: ’batch’ (Batch mode), ’gui’ (Graphical User" + 
	...
	private static void parseModeOption(CommandLine line) throws ParseException{
		...
		if((_mode!=null)&&!_mode.equals("batch")&&!_mode.equals("gui")) {
	...
	private static void startBatchMode() throws Exception {
		...
		ForceLaws f = _forceLawsFactory.createInstance(_forceLawsInfo);
		PhysicsSimulator ps = new PhysicsSimulator(_dtime, f);
		...
		Controller ctlr = new Controller (ps, _bodyFactory, _forceLawsFactory);
		ctlr.loadBodies(is);
		ctlr.run(_steps, os, expOut, stateCmp);
	}
